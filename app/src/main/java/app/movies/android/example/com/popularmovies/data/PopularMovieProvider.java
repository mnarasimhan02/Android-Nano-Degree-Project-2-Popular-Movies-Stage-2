...
public class PopularMovieProvider extends ContentProvider {
    ...
    private app.movies.android.example.com.popularmovies.data.PopularMovieDbHelper mOpenHelper;
    ...
    public boolean onCreate() {
        mOpenHelper = new app.movies.android.example.com.popularmovies.data.PopularMovieDbHelper(getContext());
        return true;
    }
